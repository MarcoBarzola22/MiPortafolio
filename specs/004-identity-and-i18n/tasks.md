...
- [ ] **T01 — Definir modelo de tipos de internacionalización en `src/types/i18n.ts`.**  
...
- [ ] **T02 — Adaptar la interfaz `CaseStudy` para narrativas traducibles en `src/types/caseStudy.ts`.**  
...
- [ ] **T03 — Implementar el contexto y proveedor liviano `src/context/I18nContext.tsx`.**  
...
- [ ] **T04 — Implementar el hook de consumo con interpolación `src/hooks/useTranslation.ts`.**  
...
- [ ] **T05 — Crear diccionario maestro en Español `src/data/locales/es.ts`.**  
...
- [ ] **T06 — Crear diccionario en Inglés con validación estricta de paridad `src/data/locales/en.ts`.**  
...
- [ ] **T07 — Vincular `src/data/caseStudies.ts` con las claves de traducción.**  
...
- [ ] **T08 — Implementar clases de doble capa de imagen y aislamiento táctil en `src/index.css`.**  
...
- [ ] **T09 — Calibrar token de contraste para textos muted en `src/index.css`.**  
...
- [ ] **T10 — Envolver la aplicación con el `I18nProvider` en `src/App.tsx`.**  
...
- [ ] **T11 — Implementar el conmutador de idioma principal accesible en `src/components/NewspaperMasthead.tsx`.**  
...
- [ ] **T12 — Integrar el conmutador de idioma compacto accesible en `src/components/NewspaperNav.tsx`.**  
...
- [ ] **T13 — Integrar fotografía real y datos verificados en `src/components/FrontPage.tsx`.**  
...
- [ ] **T14 — Actualizar Clasificados con datos de contacto reales en `src/components/ClassifiedsSection.tsx`.**  
...
- [ ] **T15 — Internacionalizar `ProjectsSection.tsx`, `ProjectCard.tsx` y `ArticleOverlay.tsx`.**  
...
- [ ] **T16 — Internacionalizar la sección técnica en `src/components/TechStackSection.tsx`.**  
...
- [ ] **T17 — Crear pruebas unitarias del motor i18n en `test/i18n/`.**  
...
- [ ] **T18 — Crear pruebas de accesibilidad y conmutación de idioma en `test/components/LanguageToggle.test.tsx`.**  
...
- [ ] **T19 — Crear pruebas de integración para Portada y Clasificados reales.**  
...
- [ ] **T20 — Verificación final de compilación, tests y build estático.**  
